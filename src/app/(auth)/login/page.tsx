...
export default function LoginPage() {
  ...
  const handleLogin = async (provider: Provider) => {
    ...
    try {
      ...
      // 네이티브: 인앱 브라우저 열림 → 딥링크로 복귀
      // 웹: 리다이렉트 → 이 페이지는 곧 사라짐
      // 30초까지 대기 후 상태 리셋 (사용자가 포기했을 가능성)
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center px-6 relative overflow-hidden bg-gradient-to-br from-blue-50 via-white to-green-50 text-gray-900">
      {/* 배경 장식 원 */}
