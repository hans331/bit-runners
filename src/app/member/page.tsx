...
function MemberPageContent() {
  ...
  return (
    <div className="max-w-5xl mx-auto px-3 md:px-6 py-4 md:py-6 space-y-4 md:space-y-6">
      ...
      <div className="card bg-gradient-to-r from-blue-500/10 to-purple-500/10 dark:from-blue-500/5 dark:to-purple-500/5 !border-blue-200 dark:!border-blue-500/20">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          ...
          <div className="flex gap-5 sm:gap-8">
            <div className="text-center"><p className="text-xl md:text-2xl font-extrabold text-blue-600 dark:text-blue-400">{totalDistance.toFixed(0)}<span className="text-sm font-medium">km</span></p><p className="text-xs text-[var(--muted)]">통산</p></div>
            <div className="text-center"><p className="text-xl md:text-2xl font-extrabold text-emerald-600 dark:text-emerald-400">#{rank}</p><p className="text-xs text-[var(--muted)]">순위</p></div>
            <div className="text-center"><p className="text-xl md:text-2xl font-extrabold text-amber-600 dark:text-amber-400">{avgPerMonth.toFixed(0)}<span className="text-sm font-medium">km</span></p><p className="text-xs text-[var(--muted)]">월평균</p></div>
          </div>
        </div>
      </div>
      ...
      <div className="card">
        <h3 className="text-base font-bold text-[var(--foreground)] mb-4">월별 목표 vs 달성</h3>
      ...
      <div className="card">
        <h3 className="text-base font-bold text-[var(--foreground)] mb-4">거리 성장 추이</h3>
      ...
      <div className="card overflow-hidden !p-0">
        <h3 className="text-base font-bold text-[var(--foreground)] p-4 pb-0">월별 기록</h3>
        <div className="overflow-x-auto"><table className="w-full text-sm"><thead><tr className="text-[var(--muted)] text-left border-b border-[var(--card-border)]">
          ...
          {memberRecords.map((r, i) => {
            ...
            return <tr key={i} className="border-b border-[var(--card-border)] last:border-0 hover:bg-[var(--card-border)]/50">
              ...
              <td className="py-2.5 px-4 text-center">{isF ? <span className="text-sm font-semibold text-emerald-600 dark:text-emerald-400 bg-emerald-500/10 px-2 py-0.5 rounded-full">달성</span> : r.achieved_km === 0 ? <span className="text-xs text-[var(--muted)]">-</span> : <span className="text-xs text-[var(--muted)] bg-slate-500/10 px-2 py-0.5 rounded-full">미달</span>}</td>
            </tr>;
          })}
        </tbody></table></div>
      </div>
    ...
    <>
      <div className="card">
        <div className="flex items-center justify-between mb-4">
          <h3 className="text-base font-bold text-[var(--foreground)]">일별 러닝 거리</h3>
      ...
      <div className="card overflow-hidden !p-0">
        <h3 className="text-base font-bold text-[var(--foreground)] p-4 pb-0">일별 러닝 기록 <span className="font-normal text-[var(--muted)]">({tableLogs.length}건)</span></h3>
        <div className="overflow-x-auto"><table className="w-full text-sm"><thead><tr className="text-[var(--muted)] text-left border-b border-[var(--card-border)]">
